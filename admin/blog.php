			...
			<div class="col-md-6 m-auto">
				<div class="panel">
					<div class="panel-body">
						<h3>Buat Blog</h3>
						<hr>
						<form method="post" action="/backend/blog_post.php" enctype="multipart/form-data">
							<div class="form-group">
								<label>Judul</label>
								<input type="text" name="title" required="" class="form-control" placeholder="Judul Blog">
							</div>
							<div class="form-group">
								<label>Konten</label>
								<textarea name="content" required="" class="form-control" placeholder="Konten Blog"></textarea>
							</div>
							<div class="form-group">
								<label>Gambar</label>
